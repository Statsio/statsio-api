        ...
        return [
            ...
            'table' => [
                ...
                'fieldMapping' => [
                    ...
                    'cellRules' => ['role' => 'any', 'list' => true, 'required' => false, 'description' => 'Mise en forme conditionnelle : [{ column, when: positive|negative|top|bottom|=|!=|>|>=|<|<=|contains|not_contains, value? (requis sauf positive/negative/top/bottom), color (hex), bold? }].'],
                ],
            ...
            'map' => [
                ...
                'fieldMapping' => [
                    ...
                    'cellRules' => ['role' => 'any', 'list' => true, 'required' => false, 'description' => 'Couleur conditionnelle des marqueurs (prioritaire sur mapColorColumn) : [{ column, when: positive|negative|top|bottom|=|!=|>|>=|<|<=|contains|not_contains, value? (requis sauf positive/negative/top/bottom), color (hex) }].'],
                    ...$this->columnLabelsField(),
                    ...$this->valueLabelsField(),
                ],
