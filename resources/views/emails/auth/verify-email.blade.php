...
<head>
  ...
  <title>Confirmez votre adresse e-mail – Statsio</title>
  <!--[if mso]>
          ...
          <tr>
            <td style="background:#ffffff;padding:40px;border-radius:0 0 20px 20px;box-shadow:0 4px 24px rgba(15,23,42,0.08);">
              ...
              <p style="margin:0 0 28px;font-size:15px;line-height:1.7;color:#64748b;">
                ...
                @endif
                Pour finaliser votre inscription, entrez le code ci-dessous sur Statsio. Il est valable <strong style="color:#475569;">15 minutes</strong>.
              </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                <tr>
                  <td style="background:linear-gradient(135deg,#f5f0ff 0%,#ede9fe 100%);border:1px solid #ddd6fe;border-radius:16px;padding:28px 24px;text-align:center;">
                    <p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:#7c3aed;">
                      Votre code de vérification
                    </p>
                    <p style="margin:0;font-size:44px;font-weight:800;letter-spacing:0.35em;color:#4c1d95;font-family:'Courier New',Courier,monospace;">
                      {{ $code }}
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="background:#fafafa;border:1px solid #e2e8f0;border-radius:12px;padding:14px 16px;">
                    <p style="margin:0;font-size:13px;color:#64748b;line-height:1.6;">
                      🔒 &nbsp;Ne partagez jamais ce code. Statsio ne vous le demandera jamais par téléphone ou e-mail.
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin:0;font-size:12px;color:#94a3b8;text-align:center;line-height:1.7;">
                Si vous n'avez pas créé de compte sur Statsio, ignorez simplement cet e-mail.<br>
