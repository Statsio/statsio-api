...
<title>Invitation à collaborer sur {{ $contentTitle }}</title>
...
<span style="display:none;font-size:1px;color:#f4f2f8;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">{{ $inviterName }} vous invite à collaborer sur « {{ $contentTitle }} ».</span>
  ...
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="width:600px;max-width:600px;background-color:#ffffff;border-radius:16px;border:1px solid #e6e1f0;">
    ...
    <tr>
      <td class="sio-pad" style="padding:28px 40px 0 40px;">
        <table role="presentation" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td bgcolor="#f2ecfd" style="background-color:#f2ecfd;border-radius:6px;padding:6px 11px;font-family:'JetBrains Mono','Courier New',Courier,monospace;font-size:11px;line-height:14px;mso-line-height-rule:exactly;font-weight:bold;letter-spacing:1px;color:#6d3fd4;text-transform:uppercase;">Invitation contenu</td>
          </tr>
        </table>
      </td>
    </tr>
    <tr>
      <td class="sio-pad" style="padding:18px 40px 0 40px;">
        <h1 class="sio-h1" style="margin:0;font-family:'Manrope',Helvetica,Arial,sans-serif;font-size:28px;line-height:36px;mso-line-height-rule:exactly;font-weight:bold;color:#18181f;letter-spacing:-0.6px;">{{ $inviterName }} vous invite à collaborer sur « {{ $contentTitle }} ».</h1>
      </td>
    </tr>
    <tr>
      <td class="sio-pad" style="padding:14px 40px 0 40px;font-family:'Manrope',Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;mso-line-height-rule:exactly;color:#55555f;">
        Acceptez pour accéder au dashboard et au Studio selon les droits accordés. Ce lien expire dans <strong style="color:#18181f;">7 jours</strong>.
      </td>
    </tr>
